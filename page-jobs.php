...
<section class="component__standardSection component__standardSection__variableHeight js-changeColor item__color__white mt-0" aria-label="white" aria-rowcount="2" data-depth="2" style="padding: 15vh 0 !important;">
    <div class="container">
        <h1 class=" font__size__48 font__color__purple text-center mb-5 pb-5">Otwarta rekrutacja na stanowiska</h1>
        <div class="row">
            <?php
                $args = array(  
                    'post_type' => 'jobs',
                ...
                $looper->the_post();
                ?>
                <div class="col-xl col-lg-4 col-12 text-center text-lg-start px-xl-5 px-2 my-4 my-lg-0 component__jobOffer__container">
...
<section class="component__standardSection component__standardSection__variableHeight js-changeColor font__color__white item__color__black mt-0" aria-label="black" aria-rowcount="2" data-depth="2">
